---
description: รัน Discovery stage — research + สัมภาษณ์ผู้ใช้เพื่อตี scope จนเข้าใจตรงกัน รองรับ mode ปรับความเข้ม (ไว/สมดุล/ละเอียด/โต้วาที)
argument-hint: "[ชื่อหัวข้องาน / slug] [mode keyword: ไว|เร็ว|quick|fast|สมดุล|ปกติ|balanced|ละเอียด|ลึก|deep|grill|ซักถามฉันหน่อย|โต้วาที|debate|ถกเถียง|แย้งกัน]"
---
