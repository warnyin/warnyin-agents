<!-- Generated: 2026-06-07 | Files scanned: ~64 | Token estimate: ~520 -->
...
| **adapters** | `src/.claude/` + `src/AGENTS.md` | thin adapter ชี้กลับ playbook กลาง (Claude Code / Codex) | `architecture.md` |
