...
- [ ] **CHANGELOG header ownership ระหว่าง multi-slice SHIP** — slice สุดท้ายเติม **วันที่** + `### Migration`; **ห้ามสร้าง/ย้าย/ลบ entries ของ slice อื่น** (ถ้า header ยังไม่มี → สร้างได้ แต่เติมเฉพาะ entries ของตัวเอง)
