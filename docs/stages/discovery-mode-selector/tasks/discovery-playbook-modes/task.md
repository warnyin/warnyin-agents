...
- [ ] 1. เพิ่ม section "Discovery modes" — taxonomy 4 ค่า + **behavior contract ต่อ mode** (`design.md §4.3`) + **ตารางเทียบ 3 แกน** (mode ≠ tier ≠ context-profile, `design.md §6` note) — _ผลลัพธ์:_ canonical taxonomy
...
- [ ] section "Discovery modes" ครบ: taxonomy 4 + behavior contract + ตารางเทียบ 3 แกน + auto-suggest precedence + 5 fixture + debate flow + fallback 3 แบบ + hard cap
