...
## 3. Sub-tasks
- [x] 1. copy C4 note เข้า `design.md` §3 item 3 (DAG-width toolkit) **หรือ** §4 step 7 (แตก tasks) — เลือกจุดที่กลมกลืน callout เดิม (`★`), สั้น — _ผลลัพธ์:_ note ปรากฏใกล้วินัย decomposition
...
- [x] note "★ starting-artifact" ปรากฏใน `src/.warnyin/workflow/stages/design.md` ใกล้ §3 item 3 หรือ §4 step 7 (ไม่ใช่ §7)
- [x] note อ้าง paper ว่า decomposition กำหนด solution ที่เอื้อมถึง + ระบุ "เสริมวินัยเดิม ไม่ใช่ knob ใหม่"
- [x] กระชับ (minimalism) — ไม่เพิ่ม gate item / ไม่แตะ §8 gate
