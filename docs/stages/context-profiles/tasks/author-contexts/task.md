...
## 3. Sub-tasks
- [ ] 1. สร้างโฟลเดอร์ `src/.warnyin/workflow/contexts/` — _ผลลัพธ์: dir ใหม่ใต้ workflow_
- [ ] 2. เขียน `research.md` ตามโครง spec §3 + สาระ §4 — _ขึ้นกับ 1_
- [ ] 3. เขียน `build.md` ตามโครง + สาระ — _ขึ้นกับ 1_
- [ ] 4. เขียน `review.md` ตามโครง + สาระ — _ขึ้นกับ 1_
- [ ] 5. เขียน `README.md` (context vs role + ตาราง context↔stage + วิธี activate + โครง card ทุกใบ) — _ขึ้นกับ 2–4 (อ้างชื่อ 3 card)_
- [ ] 6. `npm run verify:pack` + `npm test` — _ยืนยัน ship ได้ + ไม่กระทบเดิม_
...
- [ ] 4 ไฟล์ครบ โครงตรง spec §3, บาง ไม่ duplicate stage checklist
- [ ] README อธิบาย context(session) vs role(task) + ตาราง mapping ตรง design.md §4
- [ ] `npm run verify:pack` เขียว (contexts ติด tarball)
