...
5. **เขียนแผนลง** `docs/stages/<slug>/build.md §3`
...
9. **เขียนสรุปลง** `docs/stages/<slug>/build.md §4` (ผลเทส + รายการแก้ไข + จำนวนรอบ + ผล UXUI) → เสนอเข้า SHIP ด้วย `/warnyin:ship`

หมายเหตุ: ห้ามแตะไฟล์กลางใน `docs/` — `build.md §3` เขียนระดับ topic ก่อน รอ SHIP merge. เกณฑ์ปิดดู Gate ข้อ 6 ของ playbook
